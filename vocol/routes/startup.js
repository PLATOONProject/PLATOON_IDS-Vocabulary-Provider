      ...
      jsonfile.readFile(path, function(err, obj) {
        ...
        if (fs.existsSync(path)) {
          ...
          var localRepository = shell.exec(
            ...
            console.log('STARTUP='+obj.repositoryURL);
            console.log('LOCAL REPOSITORY='+localRepository);
          ...
          console.log('BORRRAR REPO=');
          console.log('BORRRAR REPO PRIVATE')
            shell.cd("..");
        ...
        console.log("Terminado el traer los datos al repositorio");
console.log("PATH ACTUAL="+shell.pwd());

	shell.mkdir('../../../../db/'+obj.vocabularyName).stdout;
        shell.cp('../../../../repoFolder/*.ttl',
              '../../../../db/'+obj.vocabularyName).stdout;
        console.log("Terminado el copiar los datos del repositorio al db");
            
        //Upload the ontology to the corresponding dataset
        var ontologyData = shell.exec(
          'find ../../../../repoFolder/ -type f -name "*.ttl"', {
            silent: false
          });
        // result of searched file of .ttl
        var ontologyName = ontologyData.substring(23, ontologyData.length);
        
        var uploadDataset=shell.exec('curl -X POST -F "data=@/home/vocolProject/repoFolder/'+ontologyName+'" fuseki_service_container:3030/'+obj.vocabularyName+'/upload')
	...
	console.log("Terminado el convertir los datos");
        var pass = function() {
...
console.log("ANTES DE GENERAR LOS JSON FILES="+obj.visualization);
